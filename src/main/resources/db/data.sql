insert into user_tb(username, password, email, created_at) values('ssar', '$2a$10$29VZAn6ex.NRQAr4APfe9e', 'ssar@nate.com', now());
insert into user_tb(username, password, email, created_at) values('cos', '$2a$10$29VZAn6ex.NRQAr4APfe9e', 'cos@nate.com', now());
